...
class HetroMADProcessor:
    def __init__(self):
        ...
        # Define exact column order to match HomoMAD
        self.final_columns = [
    ...
    def initialize_data(self):
        # Columns that need to be ensured exist (excluding source cols which we assume are there or don't generate)
        # We rely on self.final_columns for the structure
